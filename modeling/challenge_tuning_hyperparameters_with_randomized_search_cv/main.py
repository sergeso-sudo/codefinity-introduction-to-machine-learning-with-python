...
df = pd.read_csv(
    ...
    'a65bbc96-309e-4df9-a790-a1eb8c815a1c/penguins_pipelined.csv'
)
...
randomized = RandomizedSearchCV(model, param_grid, n_iter=20, random_state=0)
grid = GridSearchCV(model, param_grid)

# Train both search objects. They will find the best parameters during fitting.
grid.fit(X, y)
randomized.fit(X, y)
